...
//use if structure to  check if the year is leap or not and print out the result to HTML
if (year%400 ==0){
  document.querySelector('#is_it_leap').outerHTML= year + ' is a leap year.'
}
else if(year%4==0 && year% 100!=0){
  document.querySelector('#is_it_leap').outerHTML= year + ' is a leap year.'
}
else{
  document.querySelector('#is_it_leap').outerHTML= year+' is not a leap year.'
}
